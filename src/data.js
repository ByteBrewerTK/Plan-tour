const data = [
	
	{
		id: 1,
		name: "Konark",
		info: "Konark is a small town in the Puri district of the Indian state of Odisha (formerly known as Orissa). It is famous for the Sun Temple, a UNESCO World Heritage Site and one of the most prominent tourist attractions in India. The Konark Sun Temple is a 13th-century temple dedicated to the Hindu sun god, Surya.",
